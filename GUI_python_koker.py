...
#------------------knoppen--------------------------------------------------------------------------------------------
btn_Bereken = Button(window, text="bereken", command=btn_berekenclicked, bg="grey", fg="black", padx=22, pady=5, cursor = "hand2")   #knoppen met welke command ze aanroepen
btn_Bereken.grid(column=1, row=2)

btn_GenereerCode = Button(window, text="genereer code",command=btn_GenereerCodeclicked, bg="grey", fg="black", padx=5.3, pady=5, cursor = "hand2")
btn_GenereerCode.grid(column=1, row=4)

btn_BestandOpslaan = Button(window, text="bestand opslaan",command=btn_BestandOpslaanclicked, bg="grey", fg="black", padx=0, pady=5, cursor = "hand2")
btn_BestandOpslaan.grid(column=1, row=6)

btn_switch = Button(window, text="switch van eenheid",command=btn_switchclicked, bg="grey", fg="blue", padx=2, pady=5, cursor = "hand2")
...
lbl_Lu.grid(column=4, row=15, sticky = W, columnspan=10)

lbl_Lut = Label(window, text="Lut     Totale uitslag", anchor='w')
lbl_Lut.grid(column=4, row=16, sticky = W, columnspan=10)

lbl_Nx = Label(window, text="Nx      aantal tang overnames", anchor='w')
lbl_Nx.grid(column=4, row=17, sticky = W, columnspan=10)

lbl_Dx = Label(window, text="Dx      X maat overnames", anchor='w')
lbl_Dx.grid(column=4, row=18, sticky = W, columnspan=10)

lbl_Lg = Label(window, text="Lg      Afstand tussen de gaten", anchor='w')
lbl_Lg.grid(column=4, row=19, sticky = W, columnspan=10)

lbl_Vg = Label(window, text="Vg      Verloop per gat", anchor='w')
lbl_Vg.grid(column=4, row=20, sticky = W, columnspan=10)
...
frame.grid(row=5, column=32, rowspan=20, columnspan=5)
canvas=Canvas(frame,bg='#FFFFFF',width=400,height=600,scrollregion=(0,0,600,50000))
