...
var2 = tk.IntVar()
txt_CB = tk.Checkbutton(window,text="beide conisch?",variable=var2, onvalue=1, offvalue=0)
txt_CB.grid(column=6, row=7)

Var3 = tk.IntVar(value=1)
txt_GR = tk.Checkbutton(window,text="gaten rechts?",variable=Var3, onvalue=1, offvalue=0)
txt_GR.grid(column=6, row=12)

Var4 = tk.IntVar(value=1)
txt_GL = tk.Checkbutton(window,text="gaten links?",variable=Var4, onvalue=1, offvalue=0)
